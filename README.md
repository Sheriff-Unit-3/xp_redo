...
Luanti/Minetest mod for player experience management (xp)
...
See [installing mod](https://docs.luanti.org/for-players/installing-mods/).
...
* [`protector`](https://codeberg.org/TenPlus1/protector)
* `doors` (included in [Minetest Game](https://github.com/luanti-org/minetest_game))
...
* `screwdriver` (included in [Minetest Game](https://github.com/luanti-org/minetest_game))
...
* Trophy model/texture source: <https://github.com/mt-mods/homedecor_modpack/>
* [`xp_mese_crystal.png`](https://github.com/luanti-org/minetest_game/blob/HEAD/mods/default/textures/default_mese_crystal.png)
